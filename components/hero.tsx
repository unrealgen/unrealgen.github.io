...
export default function Hero() {
  ...
  const handleLinkClick = () => {
    window.open("https://minddrive.gumroad.com/subscribe", "_blank");
  };
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-6xl mx-auto">
        ...
        <p className="text-lg text-gray-400 mb-12 max-w-3xl mx-auto leading-relaxed">
          Revolutionary AI-powered chat assistant that transforms how you create
          and manage Unreal Engine Blueprints. Generate complex logic, debug
          issues, and accelerate your game development workflow with natural
          language commands.
        </p>
